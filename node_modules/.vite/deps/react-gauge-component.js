    ...
    var drawGrafanaOuterArc = function(gauge, resize) {
      ...
      if (gauge.props.type == GaugeComponentProps_1.GaugeType.Grafana && resize) {
        ...
        arcPaths.on("mouseleave", function(event, d) {
          return onArcMouseLeave(event, d, gauge);
        }).on("mouseout", function(event, d) {
          return onArcMouseOut(event, d, gauge);
        }).on("mousemove", (0, lodash_1.throttle)(function(event, d) {
          return onArcMouseMove(event, d, gauge);
        }, 20)).on("click", function(event, d) {
...
var require_GaugeComponent = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/index.js"(exports) {
    ...
    var GaugeComponent = function(props) {
      ...
      return react_1.default.createElement("div", { id: id2, className: "".concat(className, " ").concat(type2 == GaugeComponentProps_1.GaugeType.Semicircle ? "semicircle-gauge" : "radial-gauge"), style, ref: function(svg3) {
